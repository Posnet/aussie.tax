...
def main():
    ...
    df_redistributed = pd.read_csv('ato_2010-2024_inflation_redistributed.csv')
...
<head>
    ...
    <meta name="description" content="Interactive visualisation of Australian individual taxpayer statistics from 2010-2024. Explore income distribution, tax contributions, and demographic breakdowns across different income brackets.">
    ...
    <meta property="og:description" content="Interactive visualisation of Australian individual taxpayer statistics from 2010-2024. Explore income distribution, tax contributions, and demographic breakdowns across different income brackets.">
    ...
    <meta name="twitter:description" content="Interactive visualisation of Australian individual taxpayer statistics from 2010-2024. Explore income distribution, tax contributions, and demographic breakdowns across different income brackets.">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "WebPage",
      "name": "Aussie Tax",
      "description": "Interactive visualisation of Australian individual taxpayer statistics from 2010-2024. Explore income distribution, tax contributions, and demographic breakdowns across different income brackets.",
      "author": {
        "@type": "Person",
        "name": "Posnet",
...
<body>
    ...
    <div id="helpModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Inflation Adjustment ($<sub>24</sub>)</h3>
            <p>When enabled, this feature shows "equivalent earners" - people who had the same purchasing power in historical years as someone earning that amount in 2023-24.</p>
            <p><strong>How it works:</strong></p>
            <ul>
                <li>Uses RBA inflation data to convert historical incomes to 2023-24 dollars</li>
                <li>Redistributes people into modern income brackets based on their inflation-adjusted income</li>
                <li>Example: Someone earning $50,000 in 2010-11 had the purchasing power of $70,000 in 2023-24</li>
            </ul>
        ...
        function getYAxisTitle(totalBy, valueMode, isCumulative, isInflationAdjusted) {
            ...
            if (valueMode === 'percentage') {
                ...
                switch(totalBy) {
                    ...
                    case 'total_income_amount': title = isInflationAdjusted ? 'Total Income (2023-24 $)' : 'Total Income (AUD)'; break;
                    case 'net_tax_amount': title = isInflationAdjusted ? 'Tax Paid (2023-24 $)' : 'Tax Paid (AUD)'; break;
                    default: title = 'Value';
                }
            }
